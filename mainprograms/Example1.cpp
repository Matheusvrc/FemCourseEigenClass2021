...
int main() {
       ...
       int nElements = 10; //nElements = nNodes-1
       ...
       gmesh->Node(0).SetCo(coord);
        ...
        double deltaX = 0.1; //comprimento do elemento (h no livro do Becker)
        double deltaY = 0.0;
       ...
       gmesh->Print(cout);
        ...
        cmesh.SetMathStatement(matid,mat); //(ínidice qualquer do material, obj com nome 'mat' e tipo 'poisson')
        cmesh.AutoBuild();
