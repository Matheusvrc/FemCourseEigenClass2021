...
void ShapeQuad::Shape(const VecDouble &xi, VecInt &orders, VecDouble &phi, MatrixDouble &dphi){
    ...
    if (orders[nf-1] == 2) {
        if (nf==9){
            ...
            dphi(0,4) = (-1./2.) * xi[0] * (-1. + xi[1]) * (-1 + xi[1]);
            ...
            dphi(1,4) = (-1./2.) * (-1.+xi[0]) * (1.+xi[0]) * (-1.+xi[1]);
            ...
            dphi(0,5) = (-1./2.) * (1.+xi[0]) * (-1. + xi[1]) * (1. + xi[1]);
            ...
            dphi(1,5) = (-1./2.) * (1.+xi[0]) * (1.+xi[0]) * xi[1];
            ...
            dphi(0,6) = (-1./2.) * xi[0] * (1. + xi[1]) * (1. + xi[1]);
            ...
            dphi(1,6) = (-1./2.) * (-1.+xi[0]) * (1.+xi[0]) * (1.+xi[1]);
            ...
            dphi(0,7) = (-1./2.) * (-1+xi[0]) * (-1+xi[1]) * (1+xi[1]);
            ...
            dphi(1,7) = (-1./2.) * (-1.+xi[0]) * (-1.+xi[0]) * xi[1];
